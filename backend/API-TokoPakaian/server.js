...
if (!process.env.VERCEL) {
  app.listen(PORT, () => {
    ...
    console.log(
      `    Login Demo:        POST http://localhost:${PORT}/api/auth/login`,
    );

    console.log(`\nQuick Links (Ctrl+Click to open):`);
    console.log(
      `   • Swagger UI: \x1b]8;;http://localhost:${PORT}/api-docs\x1b\\http://localhost:${PORT}/api-docs\x1b]8;;\x1b\\`,
    );
    console.log(
      `   • Health Check: \x1b]8;;http://localhost:${PORT}/health\x1b\\http://localhost:${PORT}/health\x1b]8;;\x1b\\`,
    );
    console.log(
      `   • API Info: \x1b]8;;http://localhost:${PORT}/\x1b\\http://localhost:${PORT}/\x1b]8;;\x1b\\`,
    );
