...
async function setupDemoData() {
  ...
  try {
    ...
    const products = [
      {
        ...
        desc: "Kemeja formal lengan panjang",
        price: 150000,
        stock: 25,
        cat: "Kemeja",
      },
      ...
      },
      {
        ...
        desc: "Dress maxi dengan motif bunga",
        price: 220000,
        stock: 12,
        cat: "Dress",
      },
      {
        name: "Jaket Denim",
        desc: "Jaket denim kasual",
        price: 280000,
        stock: 15,
        cat: "Jaket",
      },
      {
        name: "T-Shirt Wanita Pink",
        desc: "T-shirt wanita warna pink",
        price: 65000,
        stock: 40,
        cat: "Kaos",
      },
    ...
    if (error.code === "ECONNREFUSED") {
      console.error(
        "Database connection failed. Make sure Supabase is reachable.",
      );
    }
  } finally {
    client.release();
